...
- The route record must distinguish the optional counter-wave branch: clean follow-up marks `counter:avoided`, while observed enemy frontline body pressure marks `counter:recorded`.
