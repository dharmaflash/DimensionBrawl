...
- 2026-06-26 verification note: `ActionFoundationBossBarrageLaneReviewSceneTests.PocketReadsBossSummonBlockAsFollowupFailure` currently fails at `UsedSkill1DuringSummonFollowup` even after reverting exploratory owner/test edits. Do not hide this; repair or rebaseline that authored-scene path before using it as a milestone gate.
