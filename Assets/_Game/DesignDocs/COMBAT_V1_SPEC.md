...
- One boss-barrage pocket can be cleared, paused, or meaningfully answered through player survival/positioning plus summon action, including a short visible follow-up window and LV1 EN pulse after a correct summon pressure block so `Skill1` can answer the opening and confirm a real boss hit.
