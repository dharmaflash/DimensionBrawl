...
- `CombatHudPresenter` is the sole in-combat HUD and reticle surface. `BossBarrageLaneReviewOverlayHud` remains limited to pause, settings, and pocket-result routing until that overlay receives its own production replacement.
