    ...
    public static class ActionFoundationCombatVfxSetup
    {
        ...
        public static CombatVfxCueProfile EnsureCombatVfxAssets()
        {
            ...
            CombatCuePrefabs prefabs = new CombatCuePrefabs
            {
                ...
                SummonSlot2BeamLock = SaveSummonSlot2BeamLockPrefab("DB_VFX_SummonSlot2BeamLock", cyan, blue, white),
                SummonSlot2BeamFire = SaveSummonSlot2BeamFirePrefab("DB_VFX_SummonSlot2BeamFire", cyan, blue, white),
                SummonSlot2BeamHit = SaveSummonSlot2BeamHitPrefab("DB_VFX_SummonSlot2BeamHit", cyan, white, gold),
                SummonSlot3ShieldRaise = SaveSummonSlot3ShieldRaisePrefab("DB_VFX_SummonSlot3ShieldRaise", gold, white, violet),
                SummonSlot3ShieldHit = SaveSummonSlot3ShieldHitPrefab("DB_VFX_SummonSlot3ShieldHit", gold, white, violet),
        ...
        private static void ConfigureCombatVfxCueProfile(CombatVfxCueProfile profile, CombatCuePrefabs prefabs)
        {
            CueDefinition[] cues =
            {
                ...
                new CueDefinition(CombatVfxCueId.SummonSlot2BeamLock, prefabs.SummonSlot2BeamLock, new Vector3(0f, 0.12f, 0.18f), Vector3.zero, new Vector3(0.72f, 0.48f, 0.72f), 0.42f, true, false),
                new CueDefinition(CombatVfxCueId.SummonSlot2BeamFire, prefabs.SummonSlot2BeamFire, Vector3.zero, Vector3.zero, Vector3.one, 0.34f, false, true),
                new CueDefinition(CombatVfxCueId.SummonSlot2BeamHit, prefabs.SummonSlot2BeamHit, Vector3.zero, Vector3.zero, new Vector3(1.05f, 0.92f, 1.05f), 0.38f, false, true),
                new CueDefinition(CombatVfxCueId.SummonSlot3ShieldRaise, prefabs.SummonSlot3ShieldRaise, Vector3.zero, Vector3.zero, new Vector3(0.72f, 0.46f, 0.72f), 0.46f, true, false),
                new CueDefinition(CombatVfxCueId.SummonSlot3ShieldHit, prefabs.SummonSlot3ShieldHit, Vector3.zero, Vector3.zero, new Vector3(0.82f, 0.58f, 0.82f), 0.34f, true, false),
        ...
        private static GameObject SaveSummonSlot2BeamLockPrefab(
            string name,
            ...
            Material sparkMaterial)
        {
            ...
            var renderers = new System.Collections.Generic.List<Renderer>
            {
                AddPrimitive(
                    root.transform,
                    "MarksmanBeamLock_TargetRing",
                    PrimitiveType.Cylinder,
                    ringMaterial,
                    new Vector3(0f, 0.015f, 0f),
                    Vector3.zero,
                    new Vector3(0.82f, 0.012f, 0.82f)),
                AddPrimitive(
                    root.transform,
                    "MarksmanBeamLock_FocusLine",
                    PrimitiveType.Cube,
                    beamMaterial,
                    new Vector3(0f, 0.06f, 0.3f),
                    Vector3.zero,
                    new Vector3(0.08f, 0.032f, 0.92f)),
                AddPrimitive(
                    root.transform,
                    "MarksmanBeamLock_CrossA",
                    PrimitiveType.Cube,
                    sparkMaterial,
                    new Vector3(0f, 0.07f, 0f),
                    Vector3.zero,
                    new Vector3(0.96f, 0.026f, 0.055f)),
                AddPrimitive(
                    root.transform,
                    "MarksmanBeamLock_CrossB",
                    PrimitiveType.Cube,
                    sparkMaterial,
            ...
            AddParticleBurst(
                ...
                0.28f,
                360f,
                new Color(0.68f, 0.94f, 1f, 0.86f));
            AddParticleBurst(
                root.transform,
                "MarksmanBeamLock_ForwardDust",
                ringMaterial,
                new Vector3(0f, 0.06f, 0.24f),
                Vector3.zero,
                0.34f,
                0.18f,
                2.1f,
                ...
                0.045f,
                18f,
                new Color(0.42f, 0.86f, 1f, 0.72f));
            ...
            ConfigureCueVisual(
                ...
                renderers.ToArray(),
                0.40f,
                new Color(0.56f, 0.96f, 1f, 0.82f),
                new Color(0.06f, 0.26f, 1f, 0f),
                new Vector3(0.66f, 0.46f, 0.66f),
                new Vector3(1.42f, 0.72f, 1.42f),
                120f,
                0.04f,
                0.06f);
        ...
        private static GameObject SaveSummonSlot2BeamFirePrefab(
            string name,
            Material beamMaterial,
            Material sideMaterial,
            Material sparkMaterial)
        {
            ...
            var renderers = new System.Collections.Generic.List<Renderer>
            {
                AddPrimitive(
                    ...
                    PrimitiveType.Cube,
                    beamMaterial,
                    new Vector3(0f, 0f, 2.34f),
                    Vector3.zero,
                    new Vector3(0.09f, 0.09f, 4.68f)),
                AddPrimitive(
                    root.transform,
                    "MarksmanBeam_Sheath",
                    PrimitiveType.Cube,
                    sideMaterial,
                    new Vector3(0f, 0f, 2.18f),
                    Vector3.zero,
                    new Vector3(0.24f, 0.035f, 4.36f)),
                AddPrimitive(
                    root.transform,
                    "MarksmanBeam_CrossFlash",
                    PrimitiveType.Cube,
                    sideMaterial,
                    new Vector3(0f, 0f, 0.36f),
                    new Vector3(0f, 38f, 0f),
                    new Vector3(0.42f, 0.035f, 0.92f)),
                AddPrimitive(
                    root.transform,
                    "MarksmanBeam_MuzzleDisc",
                    PrimitiveType.Cylinder,
                    sparkMaterial,
                    new Vector3(0f, 0f, 0.08f),
                    new Vector3(90f, 0f, 0f),
                    new Vector3(0.32f, 0.018f, 0.32f))
            };

            AddParticleBurst(
                root.transform,
                "MarksmanBeam_MuzzleSparks",
                sparkMaterial,
            ...
            AddParticleBurst(
                root.transform,
                "MarksmanBeam_LineSparks",
                sparkMaterial,
                new Vector3(0f, 0f, 1.45f),
                Vector3.zero,
                0.22f,
                0.14f,
                2.2f,
                ...
                0.08f,
                6f,
                new Color(0.52f, 0.86f, 1f, 0.84f));
            ...
            ConfigureCueVisual(
                ...
                renderers.ToArray(),
                0.28f,
                new Color(0.56f, 0.95f, 1f, 0.96f),
                new Color(0.1f, 0.26f, 1f, 0f),
                new Vector3(0.78f, 0.78f, 0.64f),
                new Vector3(1.08f, 1.32f, 1.12f),
                0f,
                0f,
                0.16f);
        ...
        private static GameObject SaveSummonSlot2BeamHitPrefab(
            string name,
            Material flashMaterial,
            Material sparkMaterial,
            Material ringMaterial)
        {
            ...
            var renderers = new System.Collections.Generic.List<Renderer>
            {
                ...
                AddPrimitive(
                    ...
                    Vector3.zero,
                    new Vector3(0.12f, 0.045f, 1.15f)),
                AddPrimitive(
                    root.transform,
                    "BeamHit_GroundRing",
                    PrimitiveType.Cylinder,
                    ...
                    new Vector3(0f, 0.015f, 0f),
                    Vector3.zero,
                    new Vector3(0.74f, 0.014f, 0.74f))
            };

            AddParticleBurst(
                root.transform,
                "BeamHit_PrismaticSpray",
                sparkMaterial,
                new Vector3(0f, 0.1f, -0.08f),
                Vector3.zero,
                0.32f,
                0.20f,
                2.9f,
            ...
            ConfigureCueVisual(
                ...
                renderers.ToArray(),
                0.32f,
                new Color(0.86f, 0.98f, 1f, 0.98f),
                new Color(0.18f, 0.48f, 1f, 0f),
                new Vector3(0.58f, 0.54f, 0.58f),
                new Vector3(1.62f, 1.18f, 1.62f),
                42f,
                0.04f,
                0.04f);
        ...
        private static GameObject SaveSummonSlot3ShieldRaisePrefab(
            string name,
            ...
            Material pressureMaterial)
        {
            ...
            var renderers = new System.Collections.Generic.List<Renderer>
            {
                AddPrimitive(
                    root.transform,
                    "VanguardShieldRaise_DomeSeed",
                    PrimitiveType.Sphere,
                    shieldMaterial,
                    new Vector3(0f, 0.18f, 0f),
                    Vector3.zero,
                    new Vector3(0.54f, 0.28f, 0.54f)),
                AddPrimitive(
                    root.transform,
                    "VanguardShieldRaise_OuterRing",
                    PrimitiveType.Cylinder,
                    flashMaterial,
                    new Vector3(0f, 0.035f, 0f),
                    Vector3.zero,
                    new Vector3(1.38f, 0.018f, 1.38f)),
                AddPrimitive(
                    root.transform,
                    "VanguardShieldRaise_FrontBrace",
                    PrimitiveType.Cube,
                    pressureMaterial,
                    new Vector3(0f, 0.11f, 0.42f),
                    Vector3.zero,
                    new Vector3(1.08f, 0.036f, 0.09f)),
                AddPrimitive(
                    root.transform,
                    "VanguardShieldRaise_VerticalBrace",
                    PrimitiveType.Cube,
                    flashMaterial,
                    new Vector3(0f, 0.16f, 0.42f),
                    new Vector3(0f, 90f, 0f),
                    new Vector3(0.62f, 0.032f, 0.07f))
            };

            AddParticleBurst(
                root.transform,
                "VanguardShieldRaise_Halo",
                flashMaterial,
                ...
                0.46f,
                360f,
                new Color(1f, 0.94f, 0.56f, 0.76f));
            AddParticleBurst(
                root.transform,
                "VanguardShieldRaise_RisingShards",
                pressureMaterial,
                new Vector3(0f, 0.08f, 0f),
                Vector3.zero,
                0.44f,
                ...
                0.22f,
                360f,
                new Color(0.92f, 0.68f, 1f, 0.70f));
            ...
            ConfigureCueVisual(
                ...
                renderers.ToArray(),
                0.46f,
                new Color(1f, 0.92f, 0.42f, 0.84f),
                new Color(0.38f, 0.12f, 1f, 0f),
                new Vector3(0.52f, 0.36f, 0.52f),
                new Vector3(1.7f, 0.86f, 1.7f),
                72f,
                0.06f,
                0f);
        ...
        private static GameObject SaveSummonSlot3ShieldHitPrefab(
            string name,
            Material shieldMaterial,
            Material flashMaterial,
            Material pressureMaterial)
        {
            ...
            var renderers = new System.Collections.Generic.List<Renderer>
            {
                ...
                AddPrimitive(
                    root.transform,
                    "VanguardShieldHit_CrossA",
                    PrimitiveType.Cube,
                    flashMaterial,
                    new Vector3(0f, 0.06f, 0f),
                    Vector3.zero,
                    new Vector3(1.55f, 0.032f, 0.08f)),
                AddPrimitive(
                    root.transform,
                    "VanguardShieldHit_CrossB",
                    PrimitiveType.Cube,
                    flashMaterial,
            ...
            AddParticleBurst(
                ...
                0.16f,
                360f,
                new Color(1f, 0.92f, 0.55f, 0.94f));
            AddParticleBurst(
                root.transform,
                "VanguardShieldHit_PressureWave",
                pressureMaterial,
                new Vector3(0f, 0.06f, 0f),
                Vector3.zero,
                0.38f,
                ...
                0.42f,
                360f,
                new Color(0.92f, 0.56f, 1f, 0.58f));
            ...
            ConfigureCueVisual(
                ...
                renderers.ToArray(),
                0.34f,
                new Color(1f, 0.88f, 0.34f, 0.94f),
                new Color(0.48f, 0.16f, 1f, 0f),
                new Vector3(0.62f, 0.48f, 0.62f),
                new Vector3(1.78f, 0.72f, 1.78f),
                80f,
                0.02f,
                0f);
        ...
        private struct CombatCuePrefabs
        {
            ...
            public GameObject SummonSlot2BeamLock;
            public GameObject SummonSlot2BeamFire;
            public GameObject SummonSlot2BeamHit;
            public GameObject SummonSlot3ShieldRaise;
            public GameObject SummonSlot3ShieldHit;
