...
namespace DimensionBrawl.Presentation
{
    ...
    public sealed class PlayerCombatVfxCueDriver : MonoBehaviour
    {
        ...
        [SerializeField, Min(0f)] private float perfectDodgeCueIntensity = 0.8f;
        ...
        [SerializeField, Min(0f)] private float perfectDodgeTimeFieldIntensity = 0.7f;
        [SerializeField, Min(0f)] private float perfectDodgePulsewaveIntensity = 0.75f;
        [SerializeField, Min(0f)] private float perfectDodgeHoloCubeIntensity = 0.6f;
        [SerializeField, Min(0f)] private float perfectDodgeWindowIntensity = 1f;
        [SerializeField, Min(0f)] private float perfectDodgeProjectileBlockIntensity = 0.85f;
