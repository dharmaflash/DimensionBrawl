...
namespace DimensionBrawl.LevelDesign
{
    ...
    public sealed class FrontlineWaveStageProfile : ScriptableObject
    {
        ...
        [SerializeField, Range(0f, 1f)] private float unansweredBossHitRoutePenalty01 = 0.08f;
        ...
        [SerializeField, Min(0f)] private float counterWaveAnswerEnergyPulseOverride;
        ...
        public float UnansweredBossHitRoutePenalty01 => Mathf.Clamp01(unansweredBossHitRoutePenalty01);
        ...
        public float CounterWaveAnswerEnergyPulseOverride => Mathf.Max(0f, counterWaveAnswerEnergyPulseOverride);
